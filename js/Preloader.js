...
AtomicCrush.Preloader.prototype = {
	...
	this.game.load.image(FE, 'assets/sprites/Fe.png');
        ...
        this.game.load.spritesheet('createButton2', AtomicCrush.language.createButton, CREATE_BUTTON_WIDTH, CREATE_BUTTON_HEIGHT);
	this.game.load.image('gridMistake','assets/sprites/Grille_Mistake.png');

        //LostPanel
        this.game.load.image('lost', 'assets/backgrounds/lost.png');
        this.game.load.spritesheet('playAgain', AtomicCrush.language.playAgainButton, LOST_BUTTON_WIDTH, LOST_BUTTON_HEIGHT);
        ...
        this.game.load.spritesheet('backToMenu', AtomicCrush.language.backToMenuButton, LOST_BUTTON_WIDTH, LOST_BUTTON_HEIGHT);        
        this.game.load.spritesheet('backToMenu', AtomicCrush.language.backToMenuButton, LOST_BUTTON_WIDTH, LOST_BUTTON_HEIGHT);        
        this.game.load.spritesheet('nextLevel', AtomicCrush.language.nextLevelButton, LOST_BUTTON_WIDTH, LOST_BUTTON_HEIGHT);        
